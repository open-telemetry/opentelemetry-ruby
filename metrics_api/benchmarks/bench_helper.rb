...
# Builds an in-memory metric reader for benchmarking.
def new_reader
  Export::InMemoryMetricPullExporter.new
end

# Builds a counter instrument with the given exemplar filter/reservoir.
...
# Builds a histogram instrument with the given exemplar filter/reservoir.
...
# Builds an SDK meter wired to an in-memory reader for benchmarking.
