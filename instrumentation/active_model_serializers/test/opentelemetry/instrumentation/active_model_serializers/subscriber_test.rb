...
require_relative '../../../../lib/opentelemetry/instrumentation/active_model_serializers/subscriber'

describe OpenTelemetry::Instrumentation::ActiveModelSerializers::Subscriber do
  ...
  module MongoTraceTest
    it 'has basic properties' do
      ...
      _(span.attributes['db.system']).must_equal 'active_model_serializersdb'
  ...
  describe '#insert_one operation' do
    ...
    describe 'for a basic document' do
      ...
      it 'has operation-specific properties' do
        ...
        _(span.attributes['db.active_model_serializersdb.collection']).must_equal 'artists'
    ...
    describe 'for a document with an array' do
      ...
      it 'has operation-specific properties' do
        ...
        _(span.attributes['db.operation']).must_equal 'insert'
        _(span.attributes['db.active_model_serializersdb.collection']).must_equal 'people'
        assert_nil(span.attributes['db.statement'])
      end
    end
  end
  ...
  describe '#drop operation' do
    ...
    it 'has operation-specific properties' do
      ...
      assert_nil(span.attributes['db.active_model_serializersdb.collection'])
      assert_nil(span.attributes['db.statement'])
    end
  end
  ...
  describe 'a failed query' do
    ...
    describe 'that triggers #failed before #started' do
      ...
      it 'does not raise error even when thread is cleared' do
        Thread.current[:__opentelemetry_active_model_serializers_spans__] = nil
        failed_event
      end
    end
  end
