  ...
  module Instrumentation
    module Elasticsearch
      module Patches
        ...
        module Client
          def self.included(base) # rubocop:disable Metrics/AbcSize, Metrics/CyclomaticComplexity, Metrics/MethodLength
            base.class_eval do # rubocop:disable Metrics/BlockLength
              alias_method :perform_request_without_otel, :perform_request
              ...
              def perform_request(*args)
                ...
                tracer.in_span(
                  ...
                  response = perform_request_without_otel(*args)
