...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'opentelemetry-instrumentation-elasticsearch', '~> 0.0.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-aws_sdk', '~> 0.2.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-dalli', '~> 0.20.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-que', '~> 0.2.0'
  spec.add_dependency 'opentelemetry-instrumentation-rack', '~> 0.20.0'
  spec.add_dependency 'opentelemetry-instrumentation-rails', '~> 0.20.0'
