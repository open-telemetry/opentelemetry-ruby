...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'opentelemetry-instrumentation-concurrent_ruby', '~> 0.6.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-redis', '~> 0.6.0'
  spec.add_dependency 'opentelemetry-instrumentation-restclient', '~> 0.6.0'
  spec.add_dependency 'opentelemetry-instrumentation-sidekiq', '~> 0.6.0'
  spec.add_dependency 'opentelemetry-instrumentation-sinatra', '~> 0.6.0'
