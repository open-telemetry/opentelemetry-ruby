...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'opentelemetry-instrumentation-concurrent_ruby', '~> 0.8.0'
  spec.add_dependency 'opentelemetry-instrumentation-dalli', '~> 0.8.0'
  spec.add_dependency 'opentelemetry-instrumentation-ethon', '~> 0.8.0'
  spec.add_dependency 'opentelemetry-instrumentation-excon', '~> 0.8.0'
  spec.add_dependency 'opentelemetry-instrumentation-faraday', '~> 0.8.0'
  spec.add_dependency 'opentelemetry-instrumentation-mysql2', '~> 0.8.0'
  spec.add_dependency 'opentelemetry-instrumentation-net_http', '~> 0.8.0'
  spec.add_dependency 'opentelemetry-instrumentation-rack', '~> 0.8.0'
  spec.add_dependency 'opentelemetry-instrumentation-redis', '~> 0.8.0'
  spec.add_dependency 'opentelemetry-instrumentation-restclient', '~> 0.8.0'
  spec.add_dependency 'opentelemetry-instrumentation-sidekiq', '~> 0.8.0'
  spec.add_dependency 'opentelemetry-instrumentation-sinatra', '~> 0.8.0'
