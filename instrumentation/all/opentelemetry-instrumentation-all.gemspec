...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'opentelemetry-instrumentation-elasticsearch', '~> 0.17.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-delayed_job', '~> 0.17.0'
  spec.add_dependency 'opentelemetry-instrumentation-ethon', '~> 0.17.0'
  spec.add_dependency 'opentelemetry-instrumentation-excon', '~> 0.17.0'
  spec.add_dependency 'opentelemetry-instrumentation-faraday', '~> 0.17.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-net_http', '~> 0.17.0'
  spec.add_dependency 'opentelemetry-instrumentation-pg', '~> 0.17.0'
  spec.add_dependency 'opentelemetry-instrumentation-rack', '~> 0.17.0'
  spec.add_dependency 'opentelemetry-instrumentation-rails', '~> 0.17.0'
  spec.add_dependency 'opentelemetry-instrumentation-redis', '~> 0.17.0'
  spec.add_dependency 'opentelemetry-instrumentation-restclient', '~> 0.17.0'
  spec.add_dependency 'opentelemetry-instrumentation-ruby_kafka', '~> 0.17.0'
  spec.add_dependency 'opentelemetry-instrumentation-sidekiq', '~> 0.17.0'
  spec.add_dependency 'opentelemetry-instrumentation-sinatra', '~> 0.17.0'
