...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'opentelemetry-instrumentation-concurrent_ruby', '~> 0.19.0'
  spec.add_dependency 'opentelemetry-instrumentation-dalli', '~> 0.19.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-graphql', '~> 0.19.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-lmdb', '~> 0.19.0'
  spec.add_dependency 'opentelemetry-instrumentation-mongo', '~> 0.18.1'
  spec.add_dependency 'opentelemetry-instrumentation-mysql2', '~> 0.19.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-que', '~> 0.1.0'
  spec.add_dependency 'opentelemetry-instrumentation-rack', '~> 0.19.0'
  spec.add_dependency 'opentelemetry-instrumentation-rails', '~> 0.19.2'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-ruby_kafka', '~> 0.18.3'
