...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'opentelemetry-instrumentation-active_model_serializers', '~> 0.12.0'
  spec.add_dependency 'opentelemetry-instrumentation-concurrent_ruby', '~> 0.12.0'
  spec.add_dependency 'opentelemetry-instrumentation-dalli', '~> 0.12.0'
  spec.add_dependency 'opentelemetry-instrumentation-delayed_job', '~> 0.12.0'
  spec.add_dependency 'opentelemetry-instrumentation-ethon', '~> 0.12.0'
  spec.add_dependency 'opentelemetry-instrumentation-excon', '~> 0.12.0'
  spec.add_dependency 'opentelemetry-instrumentation-faraday', '~> 0.12.0'
  spec.add_dependency 'opentelemetry-instrumentation-graphql', '~> 0.12.0'
  spec.add_dependency 'opentelemetry-instrumentation-mongo', '~> 0.12.0'
  spec.add_dependency 'opentelemetry-instrumentation-mysql2', '~> 0.12.0'
  spec.add_dependency 'opentelemetry-instrumentation-net_http', '~> 0.12.0'
  spec.add_dependency 'opentelemetry-instrumentation-rack', '~> 0.12.0'
