...
require_relative '../../../../../../lib/opentelemetry/instrumentation/ruby_kafka/events/consumer_group/leave_group'

describe OpenTelemetry::Instrumentation::RubyKafka::Events::ConsumerGroup::LeaveGroup do
  let(:described_class) { OpenTelemetry::Instrumentation::RubyKafka::Events::ConsumerGroup::LeaveGroup }
  ...
  it 'produces a span' do
    ...
    _(span.name).must_equal('kafka.consumer.leave_group')
