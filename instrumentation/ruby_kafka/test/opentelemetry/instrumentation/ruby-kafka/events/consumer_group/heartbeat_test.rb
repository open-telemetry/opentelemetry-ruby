...
require_relative '../../../../../../lib/opentelemetry/instrumentation/ruby_kafka/events/consumer_group/heartbeat'

describe OpenTelemetry::Instrumentation::RubyKafka::Events::ConsumerGroup::Heartbeat do
  let(:described_class) { OpenTelemetry::Instrumentation::RubyKafka::Events::ConsumerGroup::Heartbeat }
  ...
  it 'produces a span' do
    ...
    _(span.name).must_equal('kafka.consumer.heartbeat')
