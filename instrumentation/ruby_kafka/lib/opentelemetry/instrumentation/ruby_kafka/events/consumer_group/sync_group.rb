    ...
    module RubyKafka
      module Events
        module ConsumerGroup
          # The SyncGroup module contains the instrumentation for consumer group sync group event
          module SyncGroup
            extend self

            EVENT_NAME = 'sync_group.consumer.kafka'
            SPAN_NAME = 'kafka.consumer.sync_group'
