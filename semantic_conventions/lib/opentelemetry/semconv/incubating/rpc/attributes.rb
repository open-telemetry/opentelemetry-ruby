  ...
  module SemConv
    module Incubating
      module RPC
        ...
        # @deprecated {"note": "Replaced by `rpc.response.status_code`.", "reason": "renamed", "renamed_to": "rpc.response.status_code"}
        ...
        # 1.2.3.5
        #
        # @deprecated {"note": "Replaced by `rpc.request.metadata`.", "reason": "renamed", "renamed_to": "rpc.request.metadata"}
        ...
        # attribute_value
        #
        # @deprecated {"note": "Replaced by `rpc.response.metadata`.", "reason": "renamed", "renamed_to": "rpc.response.metadata"}
        ...
        #
        # @note Stability Level: development
        # @deprecated {"note": "Use string representation of the gRPC status code on the `rpc.response.status_code` attribute.", "reason": "uncategorized"}
        ...
        # 100
        #
        # @deprecated {"note": "Use string representation of the error code on the `rpc.response.status_code` attribute.", "reason": "uncategorized"}
        ...
        # User already exists
        #
        # @deprecated {"note": "Use the span status description or `error.message` attribute on other signals.", "reason": "uncategorized"}
        ...
        #
        # @deprecated {"note": "Replaced by `jsonrpc.request.id`.", "reason": "renamed", "renamed_to": "jsonrpc.request.id"}
        ...
        # 1.0
        #
        # @deprecated {"note": "Replaced by `jsonrpc.protocol.version`.", "reason": "renamed", "renamed_to": "jsonrpc.protocol.version"}
        ...
        #
        # @deprecated {"note": "Value should be included in `rpc.method` which is expected to be a fully-qualified name.", "reason": "uncategorized"}
        RPC_SERVICE = 'rpc.service'
    
        # Deprecated, use `rpc.system.name` attribute instead.
        #
        # @note Stability Level: development
        # @deprecated {"note": "Replaced by `rpc.system.name`.", "reason": "renamed", "renamed_to": "rpc.system.name"}
