  ...
  module SemConv
    module Incubating
      module V8JS
        ...
        #
        # @note Stability Level: development
        # @deprecated {"note": "Replaced by `v8js.memory.heap.space.available_size`.", "reason": "renamed", "renamed_to": "v8js.memory.heap.space.available_size"}
        V8JS_HEAP_SPACE_AVAILABLE_SIZE = 'v8js.heap.space.available_size'
    
        # Deprecated, use `v8js.memory.heap.space.physical_size` instead.
        #
        # @note Stability Level: development
        # @deprecated {"note": "Replaced by `v8js.memory.heap.space.physical_size`.", "reason": "renamed", "renamed_to": "v8js.memory.heap.space.physical_size"}
