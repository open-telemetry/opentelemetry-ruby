...
module OpenTelemetry
  ...
  module Incubating
    module HTTP
      ...
      #
      # @deprecated Now available in the stable namespace at {OpenTelemetry::SemConv::HTTP::HTTP_REQUEST_HEADER}.
      ...
      # @note StabilityLevel.STABLE
      #
      # @deprecated Now available in the stable namespace at {OpenTelemetry::SemConv::HTTP::HTTP_RESPONSE_HEADER}.
