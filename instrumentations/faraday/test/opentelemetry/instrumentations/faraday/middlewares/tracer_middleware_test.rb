...
require_relative '../../../../../lib/opentelemetry/instrumentations/faraday'
require_relative '../../../../../lib/opentelemetry/instrumentations/faraday/middlewares/tracer_middleware'

describe OpenTelemetry::Instrumentations::Faraday::Middlewares::TracerMiddleware do
  let(:instrumentation) { OpenTelemetry::Instrumentations::Faraday::Instrumentation.instance }
