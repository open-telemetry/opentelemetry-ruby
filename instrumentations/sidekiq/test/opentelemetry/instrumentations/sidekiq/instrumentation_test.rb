...
require 'test_helper'
require_relative '../../../../lib/opentelemetry/instrumentations/sidekiq'
...
describe OpenTelemetry::Instrumentations::Sidekiq::Instrumentation do
  let(:instrumentation) { OpenTelemetry::Instrumentations::Sidekiq::Instrumentation.instance }
