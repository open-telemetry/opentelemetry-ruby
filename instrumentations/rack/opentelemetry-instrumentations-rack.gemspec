...
require 'opentelemetry/instrumentations/rack/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-instrumentations-rack'
  spec.version     = OpenTelemetry::Instrumentations::Rack::VERSION
