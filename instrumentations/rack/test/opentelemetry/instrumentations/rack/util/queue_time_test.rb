...
require 'rack'
require_relative '../../../../../lib/opentelemetry/instrumentations/rack/util/queue_time'

describe OpenTelemetry::Instrumentations::Rack::Util::QueueTime do
  let(:described_class) { OpenTelemetry::Instrumentations::Rack::Util::QueueTime }
