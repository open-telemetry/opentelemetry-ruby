...
require_relative '../../../../../lib/opentelemetry/instrumentations/rack/instrumentation'
require_relative '../../../../../lib/opentelemetry/instrumentations/rack/middlewares/tracer_middleware'

describe OpenTelemetry::Instrumentations::Rack::Middlewares::TracerMiddleware do
  let(:instrumentation_module) { OpenTelemetry::Instrumentations::Rack }
  let(:instrumentation_class) { instrumentation_module::Instrumentation }
  let(:instrumentation) { instrumentation_class.instance }

  let(:described_class) { OpenTelemetry::Instrumentations::Rack::Middlewares::TracerMiddleware }
