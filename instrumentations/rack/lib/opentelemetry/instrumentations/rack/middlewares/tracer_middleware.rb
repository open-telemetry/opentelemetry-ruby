      ...
      module Middlewares
        ...
        class TracerMiddleware # rubocop:disable Metrics/ClassLength
          ...
          def create_frontend_span(env, extracted_context)
            request_start_time = OpenTelemetry::Instrumentations::Rack::Util::QueueTime.get_request_start(env)
          ...
          def tracer
            OpenTelemetry::Instrumentations::Rack::Instrumentation.instance.tracer
          end
