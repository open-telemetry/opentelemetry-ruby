...
require_relative '../../../../lib/opentelemetry/instrumentations/concurrent_ruby'

describe OpenTelemetry::Instrumentations::ConcurrentRuby::Instrumentation do
  let(:instrumentation) { OpenTelemetry::Instrumentations::ConcurrentRuby::Instrumentation.instance }
