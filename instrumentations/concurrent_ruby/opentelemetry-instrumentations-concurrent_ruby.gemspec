...
require 'opentelemetry/instrumentations/concurrent_ruby/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-instrumentations-concurrent_ruby'
  spec.version     = OpenTelemetry::Instrumentations::ConcurrentRuby::VERSION
