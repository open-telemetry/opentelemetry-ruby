...
require 'opentelemetry/instrumentations/sinatra/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-instrumentations-sinatra'
  spec.version     = OpenTelemetry::Instrumentations::Sinatra::VERSION
