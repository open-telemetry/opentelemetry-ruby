...
require_relative '../../../lib/opentelemetry/instrumentations/sinatra/instrumentation'

describe OpenTelemetry::Instrumentations::Sinatra do
  include Rack::Test::Methods

  let(:instrumentation) { OpenTelemetry::Instrumentations::Sinatra::Instrumentation.instance }
