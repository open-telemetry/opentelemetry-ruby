...
require_relative '../../../../lib/opentelemetry/instrumentations/excon'
require_relative '../../../../lib/opentelemetry/instrumentations/excon/middlewares/tracer_middleware'

describe OpenTelemetry::Instrumentations::Excon::Instrumentation do
  let(:instrumentation) { OpenTelemetry::Instrumentations::Excon::Instrumentation.instance }
