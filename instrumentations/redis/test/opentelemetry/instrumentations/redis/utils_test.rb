...
require_relative '../../../../lib/opentelemetry/instrumentations/redis/utils'

describe OpenTelemetry::Instrumentations::Redis::Utils do
  let(:utils) { OpenTelemetry::Instrumentations::Redis::Utils }
