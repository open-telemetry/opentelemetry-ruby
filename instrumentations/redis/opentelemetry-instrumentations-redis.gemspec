...
require 'opentelemetry/instrumentations/redis/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-instrumentations-redis'
  spec.version     = OpenTelemetry::Instrumentations::Redis::VERSION
