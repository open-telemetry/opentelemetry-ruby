...
require_relative '../../../../lib/opentelemetry/instrumentations/ethon'
require_relative '../../../../lib/opentelemetry/instrumentations/ethon/patches/easy'

describe OpenTelemetry::Instrumentations::Ethon::Instrumentation do
  let(:instrumentation) { OpenTelemetry::Instrumentations::Ethon::Instrumentation.instance }
