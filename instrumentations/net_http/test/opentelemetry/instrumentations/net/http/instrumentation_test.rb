...
require_relative '../../../../../lib/opentelemetry/instrumentations/net/http'
require_relative '../../../../../lib/opentelemetry/instrumentations/net/http/patches/instrumentation'

describe OpenTelemetry::Instrumentations::Net::HTTP::Instrumentation do
  let(:instrumentation) { OpenTelemetry::Instrumentations::Net::HTTP::Instrumentation.instance }
