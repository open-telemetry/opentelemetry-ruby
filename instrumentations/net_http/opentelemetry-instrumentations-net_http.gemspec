...
require 'opentelemetry/instrumentations/net/http/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-instrumentations-net_http'
  spec.version     = OpenTelemetry::Instrumentations::Net::HTTP::VERSION
