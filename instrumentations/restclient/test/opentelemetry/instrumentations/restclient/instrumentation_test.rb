...
require_relative '../../../../lib/opentelemetry/instrumentations/restclient'
require_relative '../../../../lib/opentelemetry/instrumentations/restclient/patches/request'

describe OpenTelemetry::Instrumentations::RestClient::Instrumentation do
  let(:instrumentation) { OpenTelemetry::Instrumentations::RestClient::Instrumentation.instance }
