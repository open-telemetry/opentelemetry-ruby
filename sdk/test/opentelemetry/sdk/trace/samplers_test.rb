...
describe OpenTelemetry::SDK::Trace::Samplers do
  ...
  let(:context_with_tracestate) do
    ...
    OpenTelemetry::Trace.context_with_span(tracer.non_recording_span(span_context))
  end
  ...
  describe '.parent_based' do
    ...
    let(:remote_sampled_parent_context) { OpenTelemetry::Trace.context_with_span(tracer.non_recording_span(remote_sampled_parent_span_context)) }
    let(:remote_not_sampled_parent_context) { OpenTelemetry::Trace.context_with_span(tracer.non_recording_span(remote_not_sampled_parent_span_context)) }
    let(:local_sampled_parent_context) { OpenTelemetry::Trace.context_with_span(tracer.non_recording_span(local_sampled_parent_span_context)) }
    let(:local_not_sampled_parent_context) { OpenTelemetry::Trace.context_with_span(tracer.non_recording_span(local_not_sampled_parent_span_context)) }
