...
describe OpenTelemetry::SDK::Trace::Tracer do
  ...
  let(:tracer) do
    ...
    OpenTelemetry.tracer_provider.tracer('component-tracer', '1.0.0', 'https://opentelemetry.io/schemas/1.3.0')
  end
  ...
  describe '#start_span' do
    ...
    it 'creates a span with the provided instrumentation library' do
      ...
      _(span.instrumentation_library.schema_url).must_equal('https://opentelemetry.io/schemas/1.3.0')
    end
