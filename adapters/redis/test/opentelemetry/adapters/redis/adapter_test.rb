...
require_relative '../../../../lib/opentelemetry/adapters/redis'
require_relative '../../../../lib/opentelemetry/adapters/redis/patches/client'

describe OpenTelemetry::Adapters::Redis::Adapter do
  let(:adapter) { OpenTelemetry::Adapters::Redis::Adapter.instance }
