...
Gem::Specification.new do |spec|
  ...
  spec.summary     = 'ConcurrentRuby instrumentation adapter for the OpenTelemetry framework'
  spec.description = 'ConcurrentRuby instrumentation adapter for the OpenTelemetry framework'
