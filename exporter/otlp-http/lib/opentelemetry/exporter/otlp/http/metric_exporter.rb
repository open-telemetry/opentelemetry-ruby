...
module OpenTelemetry
  module Exporter
    module OTLP
      module HTTP
        # An OpenTelemetry metric exporter that sends metrics over HTTP as Protobuf encoded OTLP ExportMetricServiceRequests.
        class MetricExporter # rubocop:disable Metrics/ClassLength
          ...
          def initialize(endpoint: OpenTelemetry::Common::Utilities.config_opt('OTEL_EXPORTER_OTLP_METRICS_ENDPOINT', 'OTEL_EXPORTER_OTLP_ENDPOINT', default: 'http://localhost:4318/v1/metrics'), # rubocop:disable Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity
          ...
          # Called to export {OpenTelemetry::SDK::Metrics::State::MetricStream}.
          #
          # @param [Enumerable<OpenTelemetry::SDK::Metrics::State::MetricStream>] metric_data the
          #   list of recorded {OpenTelemetry::SDK::Metrics::State::MetricStream} to be
          #   exported.
          # @param [optional Numeric] timeout An optional timeout in seconds.
          # @return [Integer] the result of the export.
          def export(metric_data, timeout: nil)
            return FAILURE if @shutdown

            send_bytes(OpenTelemetry::Exporter::OTLP::Common.as_encoded_emsr(metric_data), timeout: timeout)
          end

          # Called when {OpenTelemetry::SDK::Metric::MeterProvider#force_flush} is called, if
          # this exporter is registered to a {OpenTelemetry::SDK::Metric::MeterProvider}
          # object.
          #
          # @param [optional Numeric] timeout An optional timeout in seconds.
          ...
          # Called when {OpenTelemetry::SDK::Metric::MeterProvider#shutdown} is called, if
          # this exporter is registered to a {OpenTelemetry::SDK::Trace::MeterProvider}
          # object.
          #
          # @param [optional Numeric] timeout An optional timeout in seconds.
