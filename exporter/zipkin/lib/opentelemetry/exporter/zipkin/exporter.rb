    ...
    module Zipkin
      ...
      class Exporter # rubocop:disable Metrics/ClassLength
        ...
        def export(span_data, timeout: nil)
          ...
          @metrics_reporter.add_to_counter(Attributes::OTEL_ZIPKIN_EXPORTER_FAILURE, labels: { 'reason' => e.class.to_s })
        ...
        def measure_request_duration
          ...
          begin
            ...
            @metrics_reporter.record_value(Attributes::OTEL_ZIPKIN_EXPORTER_REQUEST_DURATION,
                                           value: duration_ms,
