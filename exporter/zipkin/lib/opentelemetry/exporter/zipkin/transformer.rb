    ...
    module Zipkin
      ...
      module Transformer
        ...
        def add_conditional_tags(zipkin_span, span_data, tags, service_name)
          ...
          tags['otel.dropped_attributes_count'] = dropped_attributes_count.to_s if dropped_attributes_count > 0
          tags['otel.dropped_events_count'] = dropped_events_count.to_s if dropped_events_count > 0
          tags['otel.dropped_links_count'] = dropped_links_count.to_s if dropped_links_count > 0
