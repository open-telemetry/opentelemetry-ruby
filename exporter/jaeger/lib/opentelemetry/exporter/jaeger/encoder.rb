    ...
    module Jaeger
      ...
      module Encoder # rubocop:disable Metrics/ModuleLength
        ...
        def encoded_span(span_data) # rubocop:disable Metrics/AbcSize
          ...
          tags << encoded_tag('otel.dropped_attributes_count', dropped_attributes_count) if dropped_attributes_count > 0
          tags << encoded_tag('otel.dropped_events_count', dropped_events_count) if dropped_events_count > 0
          tags << encoded_tag('otel.dropped_links_count', dropped_links_count) if dropped_links_count > 0
