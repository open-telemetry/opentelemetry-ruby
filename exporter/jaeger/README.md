...
## :warning: EOL NOTICE 2025-12-31
  ...
  The `opentelemetry-exporter-jaeger` gem is deprecated and will no longer be maintained. Users are encouraged to migrate to the `opentelemetry-exporter-otlp` gem for future-proof OpenTelemetry integration. See the official docs for details <https://www.jaegertracing.io/docs/latest/migration/>
