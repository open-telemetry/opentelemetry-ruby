...
describe OpenTelemetry::Exporter::OTLP::MetricsExporter do
  ...
  describe '#initialize' do
    ...
    it 'provides a useful, spec-compliant default user agent header' do
      _(METRICS_DEFAULT_USER_AGENT).must_match("OTel-OTLP-MetricsExporter-Ruby/#{VERSION}")
            ...
            Opentelemetry::Proto::Metrics::V1::ResourceMetrics.new(
              resource: Opentelemetry::Proto::Resource::V1::Resource.new(
                attributes: [
                  ...
                  Opentelemetry::Proto::Common::V1::KeyValue.new(key: 'telemetry.sdk.version', value: Opentelemetry::Proto::Common::V1::AnyValue.new(string_value: '1.3.1'))
                ]
              ),
              scope_metrics: [
