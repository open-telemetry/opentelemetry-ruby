  ...
  module Exporter
    module OTLP
      ...
      module Util # rubocop:disable Metrics/ModuleLength
        ...
        def self.http_connection(uri, ssl_verify_mode, certificate_file)
        ...
        def self.as_otlp_any_value(value)
        ...
        def self.prepare_headers(config_headers)
        ...
        def self.backoff?(retry_count:, reason:, retry_after: nil) # rubocop:disable Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity
        ...
        def self.handle_redirect(location); end
      end
    end
  end
end
