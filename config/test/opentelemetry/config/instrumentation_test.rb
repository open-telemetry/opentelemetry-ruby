...
describe OpenTelemetry::Config do
  ...
  def with_name_map(map)
    original = OpenTelemetry::Config.method(:build_instrumentation_name_map)
    OpenTelemetry::Config.singleton_class.undef_method(:build_instrumentation_name_map)
    OpenTelemetry::Config.define_singleton_method(:build_instrumentation_name_map) { map }
    yield
  ensure
    OpenTelemetry::Config.singleton_class.undef_method(:build_instrumentation_name_map)
    OpenTelemetry::Config.define_singleton_method(:build_instrumentation_name_map, original)
  end
  ...
  describe 'instrumentation' do
    describe 'build_instrumentation_name_map' do
      it 'returns a Hash for the current registry' do
        result = OpenTelemetry::Config.build_instrumentation_name_map
