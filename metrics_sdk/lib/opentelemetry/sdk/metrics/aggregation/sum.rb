  ...
  module SDK
    module Metrics
      module Aggregation
        ...
        class Sum
          def initialize(aggregation_temporality: ENV.fetch('OTEL_EXPORTER_OTLP_METRICS_TEMPORALITY_PREFERENCE', :delta)) # the default should be :cumulative, but we haven't implemented it yet
