      ...
      module Aggregation
        ...
        class ExponentialBucketHistogram # rubocop:disable Metrics/ClassLength
          ...
          def initialize(
            ...
            @previous_positive = new_stream_storage # nil
            @previous_negative = new_stream_storage # nil
            @previous_min = new_stream_storage # Float::INFINITY
            @previous_max = new_stream_storage # -Float::INFINITY
            @previous_sum = new_stream_storage # 0
            @previous_count = new_stream_storage # 0
            @previous_zero_count = new_stream_storage # 0
            @previous_scale = new_stream_storage # nil

            @mappings = new_stream_storage
            @previous_mappings = new_stream_storage
          end
