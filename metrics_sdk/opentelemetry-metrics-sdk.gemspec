...
require 'opentelemetry/metrics_sdk/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-metrics-sdk'
  spec.version     = OpenTelemetry::MetricsSDK::VERSION
  ...
  if spec.respond_to?(:metadata)
    spec.metadata['changelog_uri'] = "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-metrics-sdk/v#{OpenTelemetry::MetricsSDK::VERSION}/file.CHANGELOG.html"
    spec.metadata['source_code_uri'] = 'https://github.com/open-telemetry/opentelemetry-ruby/tree/main/api'
    spec.metadata['bug_tracker_uri'] = 'https://github.com/open-telemetry/opentelemetry-ruby/issues'
    spec.metadata['documentation_uri'] = "https://open-telemetry.github.io/opentelemetry-ruby/opentelemetry-metrics-sdk/v#{OpenTelemetry::MetricsSDK::VERSION}"
  end
end
